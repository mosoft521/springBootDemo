...
import com.gmail.mosoft521.util.LogFactory;
import com.gmail.mosoft521.util.LogUtil;
...
public class JulLogTest {
    ...
    static {
        ...
        LogUtil.addFileHandler(sysLog, Level.INFO, LogFactory.LOG_FOLDER + File.separator + "jul.log");
    }
